...
public class SearchAgent extends Agent {
    ...
    protected void setup() {
        ...
        // prepare agent description for registration in JADE Yellow Pages
        ...
        // make agent listenining to lists of other agents with give time intervals
    ...
    public void search(String firstName, String lastName) throws SearchException {
        try {
            ...
            if (users.size() > 0) {
                ...
                // TODO: sent request to another agent
